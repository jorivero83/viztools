...
footer_temp = """
	 ...
	 <footer class="page-footer grey darken-4">
	   ...
	   <div class="col l3 s12">
	          ...
	          <ul>
	          <a href="https://www.linkedin.com/in/riverodones/" target="_blank" class="white-text">
	            <i class="fab fa-linkedin fa-4x"></i>
	          </a>
	           <a href="https://github.com/jorivero83" target="_blank" class="white-text">
...
# import pandas as pd
# url = 'https://raw.githubusercontent.com/Jcharis/Streamlit_DataScience_Apps/master/EDA_app_with_Streamlit_Components/heart_failure_clinical_records_dataset.csv'
# df = pd.read_csv(url, sep=',', decimal='.', error_bad_lines=False)
# df.to_csv('heart_failure_clinical_records_dataset.csv', index=False, sep=',', decimal='.')